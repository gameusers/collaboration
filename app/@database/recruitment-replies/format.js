...
const formatRecruitmentRepliesArr = ({
  ...
  for (let valueObj of arr.values()) {
    ...
    const recruitmentComments_id = lodashGet(valueObj, ['recruitmentComments_id'], '');
    ...
    if (replyToObj) {
      ...
      clonedObj.replyToName = lodashGet(replyToObj, ['cardPlayersObj', 'name'], '');
      ...
      if (!clonedObj.replyToName) {
        ...
        if (lodashHas(replyToFilteredArr, [0])) {
          ...
          clonedObj.replyToName = lodashGet(replyToFilteredArr, [0, 'name'], '');
