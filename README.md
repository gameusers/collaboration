...
[![node](https://img.shields.io/badge/node-v8.14.1-lightgrey.svg)](https://nodejs.org/ja/)
[![npm](https://img.shields.io/badge/npm-v6.5.0-blue.svg)](https://www.npmjs.com/)
...
## 6. ログイン情報
データベースにデータを挿入すると、ログインできるユーザーが追加されます。表示にログインが必要なコンテンツを表示する場合は、以下の情報をログインページで入力してみてください。<br /><br />

1. ID：8OM0dhDak　パスワード：8OM0dhDak0
2. ID：enPLLYBBEg3y　パスワード：enPLLYBBEg3y0
3. ID：nzPR7R9GO　パスワード：nzPR7R9GO0
<br /><br />
