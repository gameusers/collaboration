...
class Store {
  ...
  async handleNavigationFormSearchSubmit({
    ...
    try {
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-threads/search`,
        methodType: 'POST',
  ...
  async handleReadRecruitmentReplies({
    ...
    try {
      ...
      // const threadLimit = parseInt((storeData.getCookie({ key: 'recruitmentThreadLimit' }) || process.env.RECRUITMENT_THREAD_LIMIT), 10);
      const commentLimit = parseInt((storeData.getCookie({ key: 'recruitmentCommentLimit' }) || process.env.RECRUITMENT_COMMENT_LIMIT), 10);
      let replyLimit = parseInt((storeData.getCookie({ key: 'recruitmentReplyLimit' }) || process.env.RECRUITMENT_REPLY_LIMIT), 10);
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-replies/read-replies`,
        methodType: 'POST',
        formData: JSON.stringify(formDataObj),
  ...
  async handleShowFormRecruitmentReply({ pathArr, recruitmentReplies_id }) {
    ...
    try {
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-replies/get-edit-data`,
        methodType: 'POST',
        formData: JSON.stringify(formDataObj),
  ...
  async handleSubmitRecruitmentReply({
    ...
    try {
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-replies/upsert`,
        methodType: 'POST',
        formData: JSON.stringify(formDataObj),
  ...
  async handleDeleteRecruitmentThread({
    ...
    try {
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-threads/delete`,
        methodType: 'POST',
        formData: JSON.stringify(formDataObj),
  ...
  async handleDeleteRecruitmentComment({
    ...
    try {
      ...
      const resultObj = await fetchWrapper({
        ...
        urlApi: `${process.env.URL_API}/v2/db/recruitment-comments/delete`,
        methodType: 'POST',
        formData: JSON.stringify(formDataObj),
