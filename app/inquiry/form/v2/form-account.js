  ...
  const handleSubmit = async ({
    ...
    try {
      ...
      if (
        ...
        throw new CustomError({ errorsArr: [{ code: 'Sh6Vg7TDB', messageID: 'uwHIKBy7c' }] });
    ...
    >
      ...
      >
        ...
        <p
          ...
          `}
        >
          Game Users は先日リニューアルを行いました。リニューアル前のアカウントを利用するには、こちらのフォームに必要な情報を入力して送信する必要があります。
        </p>
        ...
        <p
          ...
          `}
        >
          <span style={{ fontWeight: 'bold' }}>記入例）</span><br />
          ユーザーページのURL：https://gameusers.org/ur/az1979<br />
          ログインID：login-id<br />
          ソーシャルログイン：Twitter<br />
          プロバイダー：OCN<br />
          端末：iPhone<br />
          ブラウザ：Safari<br />
          コメント：5年くらい前にアカウントを作成した記憶があります。<br />
