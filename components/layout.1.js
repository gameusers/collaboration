...
class Component extends React.Component {
  ...
  codeHeader() {
    ...
    const codeHeaderMenuArr = [];
    
    for (const [key, value] of this.props.stores.index.headerMenuArr.entries()) {
      codeHeaderMenuArr.push(
        <ButtonHeaderBottomMenu key={key}>
          {value.name}
  ...
  render() {
    ...
    // Object.entries(this.props.stores.header.headerMenuObj).forEach(
    //   ([key, value]) => console.log(key, value)
    // );
    
    // for (const [key, value] of Object.entries(this.props.stores.index.headerMenuObj)) {
    //   console.log(`${key}: ${value}`);
    // }
