...
export default async (req, res) => {
  ...
  try {
    ...
    if (loginUsersRole !== 'administrator') {
      ...
      statusCode = 403;
      throw new CustomError({ level: 'warn', errorsArr: [{ code: '96usIrIdY', messageID: 'DSRlEoL29' }] });
    ...
    // ユーザーが存在しない場合はエラー
    if (!usersObj) {
      throw new CustomError({ level: 'warn', errorsArr: [{ code: 'Gq2VpBWU8', messageID: 'cvS0qSAlE' }] });
    }
