...
module.exports = withCSS({
  ...
  env: {
    ...
    FORUM_THREADS_LIST_LIMIT: process.env.FORUM_THREADS_LIST_LIMIT,
    FORUM_COMMENTS_LIMIT: process.env.FORUM_COMMENTS_LIMIT,
    FORUM_REPLIES_LIMIT: process.env.FORUM_REPLIES_LIMIT,
    FORUM_THREADS_RELOAD_MINUTES: process.env.FORUM_THREADS_RELOAD_MINUTES,
