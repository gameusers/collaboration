...
const upsert = async ({ conditionObj, saveObj }) => {
  ...
  try {
    ...
    return await SchemaTitles.findOneAndUpdate(conditionObj, saveObj, { upsert: true, new: true, setDefaultsOnInsert: true }).exec();
...
//     let resultArr = await SchemaTitles.aggregate([
...
//     const resultArr = await SchemaTitles.aggregate([
