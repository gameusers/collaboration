...
class Store {
  ...
  //   if (initialDataObj) {
  //     // this.insertHistoryState(initialDataObj.historyStateObj);
  //     // this.insertPanelExpanded(initialDataObj);
  //     // console.dir(this.panelExpandedObj);
  //   }
...
// export default function initStoreLayout(isServer, initialDataObj) {
export default function initStoreLayout(argumentsObj) {
  
  const isServer = argumentsObj.isServer;
  // const pathname = argumentsObj.pathname;
  // const storeInstanceObj = argumentsObj.storeInstanceObj;
  // const initialDataObj = argumentsObj.initialDataObj;
