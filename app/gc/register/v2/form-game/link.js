      ...
      >
        ...
        >
          ...
          <FormControl>
            ...
            <Select
              ...
              _id="linkType"
              value={type}
              onChange={(eventObj) => handleOnChangeType({ index, value: eventObj.target.value })}
            >
        ...
        {valueObj.type === 'Other' &&
          <TextField
            ...
            label="リンクのタイトル"
            value={label}
            onChange={(eventObj) => handleOnChangeLabel({ index, value: eventObj.target.value })}
            error={labelError}
        ...
        <TextField
          ...
          label="URL"
          value={url}
          onChange={(eventObj) => handleOnChangeURL({ index, value: eventObj.target.value })}
          error={urlError}
