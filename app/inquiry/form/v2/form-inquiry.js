  ...
  const handleSubmit = async ({
    ...
    try {
      ...
      if (
        ...
        throw new CustomError({ errorsArr: [{ code: 'MxNRxHj8G', messageID: 'uwHIKBy7c' }] });
    ...
    >
      ...
      >
        ...
        <p
          ...
          `}
        >
          Game Usersへの連絡はこちらのフォーム、または <Link href="/uc/official">Game Users 公式コミュニティ</Link>を利用して行ってください。
        </p>
