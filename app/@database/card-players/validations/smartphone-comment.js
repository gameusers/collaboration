 ...
 */
const validationCardPlayersSmartphoneComment = ({ required, value }) => {
  ...
  try {
    ...
    if (required && validator.isEmpty(data)) {
      ...
      resultObj.errorCodeArr.push('uZV0Pbn0t');
    ...
    if (!validator.isLength(data, { min: minLength, max: maxLength })) {
      ...
      resultObj.errorCodeArr.push('h-ZxOPruO');
    }
    ...
    resultObj.errorCodeArr.push('hzlxQo0_7');
...
module.exports = validationCardPlayersSmartphoneComment;