...
const findFeed = async ({
  ...
  try {
    ...
    const forumThreadsGcObj = formatFeedsArr({
    ...
    const forumRecruitmentsObj = formatFeedsArr({
  
      localeObj,
      arr: docRecruitmentsArr,
      page,
      limit,
    ...
    // console.log(`
    //   ----- forumThreadsGcObj -----\n
    //   ${util.inspect(JSON.parse(JSON.stringify(forumThreadsGcObj)), { colors: true, depth: null })}\n
    //   --------------------\n
    // `);

    console.log(`
      ----- forumRecruitmentsObj -----\n
      ${util.inspect(JSON.parse(JSON.stringify(forumRecruitmentsObj)), { colors: true, depth: null })}\n
      --------------------\n
    `);
