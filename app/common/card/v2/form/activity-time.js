      ...
      >
        ...
        >
          ...
          <TextField
            ...
            type="time"
            value={beginTime}
            onChange={(eventObj) => handleOnChangeTime({ index, value: eventObj.target.value, type: 'beginTime' })}
          ...
          <TextField
            ...
            type="time"
            value={endTime}
            onChange={(eventObj) => handleOnChangeTime({ index, value: eventObj.target.value, type: 'endTime' })}
            error={endTimeError}
