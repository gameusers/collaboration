...
const validationEmailConfirmationsEmailConfirmationIDServer = async ({ value }) => {
  ...
  if (!validator.isLength(data, { min: minLength, max: maxLength })) {
    throw new CustomError({ level: 'warn', errorsArr: [{ code: 'OkacnTHUE', messageID: 'ilE2NcYjI' }] });
  }
  ...
  if (count === 0) {
    throw new CustomError({ level: 'warn', errorsArr: [{ code: 'FbtOHKatU', messageID: 'Xt11v41pR' }] });
  }
