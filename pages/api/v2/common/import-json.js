...
export default async (req, res) => {
  ...
  try {
    ...
    const redirectGamesUrlIDObj = {

      'assassins-creed-unity': 'Assassins-Creed-Unity',
      'cod-aw': 'Call-of-Duty-Advanced-Warfare',
      'gta5': 'Grand-Theft-Auto-V',
      'company-of-heroes2': 'Company-of-Heroes-2',
      'dtnk-sd-as': 'Downtown-Nekketsu-Koshinkyoku-Soreyuke-Daiundokai-All-Star-Special',
      'gundam-online': 'GUNDAM-ONLINE',
      'pokemon-oras': 'Pokemon-Omega-Ruby-and-Alpha-Sapphire',
      'watch-dogs': 'Watch-Dogs',
      'p4u2': 'Persona4-the-Ultimax-Ultra-Suplex-Hold',
      'monster-hunter': 'MONSTER-HUNTER',
      'darksouls': 'DARK-SOULS',
      'digimon-world': 'DIGIMON-WORLD',
      'lbp3': 'LittleBigPlanet3',
      ...
      'ikki-online': 'Ikki-Online',
      'kancolle': 'Kantai-Collection',
      'fallout': 'Fallout',
      'minecraft': 'Minecraft',
      'battlefield2': 'Battlefield-2',
      'lol': 'League-of-Legends',
      'dragon-quest10': 'DRAGON-QUEST-X',
      'ddon': 'Dragons-Dogma-Online',
      'mgs5': 'METAL-GEAR-SOLID-V',
      'logres': 'Logres-of-Swords-and-Sorcery',
      'pawapuro': 'Jikkyo-Powerful-Pro-Yakyu',
      'shironekoproject': 'Shironeko-Project',//White-Cat-Project
      'magicianwiz': 'Kuroneko-no-Wiz',
      'nekoatsume': 'Neko-Atsume',
      'granbluefantasy': 'Granblue-Fantasy',
      'monster-strike': 'Monster-Strike',
      'puzzle-and-dragons': 'Puzzle-and-Dragons',
      'jinrou': 'Are-You-a-Werewolf',
      'splatoon': 'Splatoon',
      'maplestory-pocket': 'MapleStory-Pocket',
      'crashfever': 'Crash-Fever',
      'agar-io': 'Agar-io',
      'planet-vader': 'Planet-Vader',
      'toram-online': 'Toram-Online',
      'makaipicnic': 'Makai-Picnic',
      'crusaders-quest': 'Crusaders-Quest',
      'valhalla-cube': 'Valhalla-Cube',
      'poitto-hero': 'Poitto-Hero',
      'mh-xr': 'MONSTER-HUNTER-EXPLORE',
      'terra-battle': 'Terra-Battle',
      'summons-board': 'Summons-Board',
      'kerihime-sweets': 'Kerihime-Sweets',
      'moji-popn': 'MOJI-POPN',
      'sangoku-tenka-trigger': 'Sangoku-Tenka-Trigger',
      'picotto-kingdom': 'Picotto-Kingdom',
      'dokuro': 'Dokuro',
      'divine-gate': 'Divine-Gate',
      'crazy-tower': 'CRAZY-TOWER',
      'sengoku-tenka-trigger': 'Sengoku-Tenka-Trigger',
      'ragnarok-online-mobile-story': 'Ragnarok-Online-Mobile-Story',
      'rogue-creator': 'Rogue-Creator',
      'seishun-exp': 'SEISHUN-Exp',
      'taiko-no-tatsujin-plus': 'Taiko-no-Tatsujin-Plus',
      'tansaquest': 'TANSAQUEST',
      'egttr': 'Everybodys-Gone-to-the-Rapture',
      'ff14': 'FINAL-FANTASY-XIV',
      'puyopuyotetris': 'Puyo-Puyo-Tetris',
      'sega-mj': '‎SEGA-NET-MAHJONG-MJ',
      'atelier-decola-doll-collection': 'Atelier-Deco-La-Doll-Collection',
      'zombi': 'Zombi',
      'hospital': 'HOSPITAL-6-nin-no-Ishi',
      'oboromuramasa': 'Oboro-Muramasa',
      'tatakae-butasan': 'Tatakae-Butasan',
      'chronus-arc': 'Chronus-Arc',
      'marugoukaku-kaigo27': 'Marugoukaku-Kaigofukushishi-Shiken-Heisei-27-nendoban',
      'final-fantasy-type-0': 'FINAL-FANTASY-TYPE-0',
      'world-neverland-elnea': 'WorldNeverland-Elnea-Kingdom',
      'xuccess-heaven': 'Xuccess-Heaven',
      'sd-gundam-strikers': 'SD-GUNDAM-STRIKERS',
      'phantom-of-the-kill': 'Phantom-of-the-Kill',
      'line-rangers': 'LINE-Rangers',
      'girl-friend-kari': 'Girl-Friend-Kakko-Kari',
      'girl-friend-kare': 'Girl-Friend-Kakko-Kare',
      'suparobo-x': 'SUPER-ROBOT-WARS-X',
      'super-gundam-royal': 'SUPER-GUNDAM-ROYALE',
      'kairisei-ma': 'Kairisei-Million-Arthur',
      'little-noah': 'Little-Noah',
      'jusou': 'THE-JUSOU',
      'arad': 'Arad-Senki',
      'mh-4g': 'MONSTER-HUNTER-4G',
      'ff11': 'FINAL-FANTASY-XI',
      'monstergear': 'MONSTER-GEAR',
      'warframe': 'WARFRAME',
      'shirodora': 'Shiro-to-Dragon',
      'kagiru': 'Kagi-to-Maho-to-Roulette',
      'dominations': 'DomiNations',
      'flyff-puzmon': 'Flyff-Puzmon',
      'tamahime': 'Tamano-Yasumi-ha-Himesama-to',
      'bof6': 'BREATH-OF-FIRE-6',
      'march-of-empires': 'March-of-Empires',
      'fate-go': 'Fate-Grand-Order',
      'skylock': 'SKYLOCK',
      'ffl-ts': 'FINAL-FANTASY-LEGENDS',
      'lifeline': 'Lifeline',
      'hearthstone': 'Hearthstone',
      'reinedesfleurs': 'Reinedes-Fleurs',
      'r-vs-j': 'Romeo-VS-Juliet',
      'suparobo-bx': 'SUPER-ROBOT-WARS-BX',
      'rainbow-six-vegas': 'Rainbow-Six-Vegas',
      'monokage-quest': 'Monokage-Quest',
      'dishonored': 'Dishonored',
      'dishonored2': 'Dishonored-2',
      'untildawn': 'Until-Dawn',
      'rearpheles': 'Red-of-Another',
      'himawari': 'Himawari-Pebble-in-the-Sky',
      'jyuzaengi': 'Jyuzaengi-Engetsu-Sangokuden',
      'dragon-quest8': 'DRAGON-QUEST-VIII',
      'famicom-remix-bc': 'Famicom-Remix-Best-Choice',
      'kobakawa': 'Kobayashi-ga-Kawaisugite-Tsurai',
      'tetsutabi-yui': 'Tetsudou-Nippon-Rosen-Tabi-Yui-Rail-Hen',
      'schoolofragnarok': 'School-of-Ragnarok',
      'imas-cinderella-g4u': 'THE-iDOLMASTER-Cinderella-Girls-G4U',
      'pri-para-pritickemaker': 'Pri-Para-Pritickemaker',
      'junen': 'Junen-Damzoko-no-Kaidan',
      'jissha-jukai': 'Jissha-Jukai-Karano-Dasshutsu',
      'owakari': 'Owakariitadaketadarouka',
      'toshidensetsu': 'ToshiDensetsu-Sugisawamura-Karano-Dasshutsu',
      'five-nights-at-freddys4': 'Five-Nights-at-Freddys-4',
      'girl-friend-onpu': 'Girl-Friend-Kakko-Onpu',
      'escape': 'Escape',
      'hagane-orchestra': 'Hagane-Orchestra',
      'chaosdragon': 'Chaos-Dragon',
      'mahouka-lz': 'Mahouka-Koukou-no-Rettousei-Lost-Zero',
      'q': 'liica-Q',
      'magic-castle-di': 'Disney-Magic-Castle-Dream-Island',
      'mobius-ff': 'MOBIUS-FINAL-FANTASY',
      'pictlogica-ff': 'PICTLOGICA-FINAL-FANTASY',
      'jusou-rei': 'Jusou-Rei',
      'yume-100': 'YumeOukoku-to-Nemureru-100-nin-no-Oujisama',
      'derby-road': 'Derby-Road',
      'royflu': 'Royal-Flush-Heroes',
      'lcattoo': 'LARA-CROFT-AND-THE-TEMPLE-OF-OSIRIS',
      'the-last-of-us': 'The-Last-of-Us',
      'fifa15': 'FIFA15',
      'pes2015': 'Winning-Eleven-2015',// Pro-Evolution-Soccer2015
      'dota2': 'Dota-2',
      'the-last-of-us2': 'The-Last-of-Us-2',
      'pocket-footballer': 'POCKET-FOOTBALLER',
      'cod-bo3': 'Call-of-Duty-Black-Ops-III',
      'starwars-battlefront': 'Star-Wars-Battlefront',
      'gundam-bon': 'Gundam-Battle-Operation-NEXT',
      'yamada-kun': 'Yusha-Yamada-kun',
      'million-onion-hotel': 'Million-Onion-Hotel',
      'motokano': 'Motokano-to-Imakano-to-Boku',
      'chrono-dragon': 'Chrono-Dragon',
      'shoumetsu-toshi': 'AFTERLOST',
      'shingun-destroy': 'Shingun-Destroy',
      'narucole': 'Naruto-Shinobi-Collection-Shippu-Ranbu',
      'zeeo': 'ZEEO',
      'pocodun': 'Pocoron-Dungeons',

      'horsaga': 'Hortensia-SAGA',
      'ange-vierge-gb': 'Ange-Vierge-Girls-Battle',
      'tokyo-7th-sisters': 'Tokyo-7th-Sisters',
      'school-girl-strikers': 'School-Girl-Strikers',
      'grimoire': 'Grimoire-Shiritsu-Grimoire-Mahou-Gakuen',
      'school-fanfare': 'School-Fanfare',
      'angel-stone': 'Angel-Stone',
      'battlecats': 'The-Battle-Cats',
      'girlsmons': 'Girls-Monsters',
      'brave-frontier': 'Brave-Frontier',

      'valiant-knights': 'VALIANT-KNIGHTS',
      'realdgame-3ds': 'Real-Dasshutsu-Game-3DS',
      'is2lp': 'INFINITE-STRATOS2-Love-and-Purge',
      'lego-ninjago': 'LEGO-NINJAGO',
      'jump-yusha': 'Jump-Yusha',
      'drift-spirits': 'DRIFT-SPIRITS',
      'sudden-attack': 'Sudden-Attack',
      'imas-sl-stage': 'THE-iDOLMASTER-Cinderella-Girls-Starlight-Stage',
      'sen-no-kaizoku': 'Sen-no-Kaizoku',
      'bakumatsu-rock-us': 'Bakumatsu-Rock-ULTIMATE-SOUL',

      'finger-knights': 'FINGER-KNIGHTS',
      'one-piece-grand-battle': 'One-Piece-Grand-Battle',
      'one-piece-super-grand-battle': 'One-Piece-Super-Grand-Battle',
      'one-piece-gigant-battle': 'One-Piece-Gigant-Battle',
      'one-piece-gigant-battle2': 'One-Piece-Gigant-Battle-2',
      'golondia': 'GOLONDIA',
      'in-space-we-brawl': 'In-Space-We-Brawl',
      'super-mario-maker': 'Super-Mario-Maker',
      'winning-post8': 'Winning-Post8',
      'daikoukai-jidai-online': 'Daikoukai-Jidai-Online',// Uncharted Waters Online

      'vs-excitebike': 'VS-Excitebike',
      'exerion': 'EXERION',
      'bomberman-panic-bomber': 'Bomberman-Panic-Bomber',
      'forza6': 'Forza-Motorsport-6',
      'destiny': 'Destiny',
      'nobunaga-no-yabou-souzou': 'Nobunaga-no-Yabou-Souzou',
      'sengoku-musou4-empires': 'Sengoku-Musou4-Empires',
      'amamiso': 'Amamitsusorani-Kumonohatateni',
      'nanarin': 'Nanairo-Reincarnation',
      'yunohana-spring': 'Yunohana-Spring',

      'resident-evil-revelations2': 'BIOHAZARD-Revelations-2',// Resident-Evil-Revelations2
      'world-trigger-bm': 'World-Trigger-Borderless-Mission',
      'saki-zenkokuhen': 'Saki-Zenkokuhen',
      'tokyo-onmyoji-tr': 'Tokyo-Onmyoji-Tengen-Terahashi-Rei',
      'genji-koiemaki': 'Genji-Koiemaki',
      'pokemon-cho-dungeon': 'Pokemon-Super-Mystery-Dungeon',
      'resident-evil': 'BIOHAZARD',// Resident-Evil
      'world-of-warships': 'World-of-Warships',
      'fifa16': 'FIFA16',
      'elderscrolls-online': 'The-Elder-Scrolls-Online',

      'battlegirl-hs': 'Battle-Girl-High-School',
      'houkai-gakuen': 'Houkai-Gakuen',// Collapse Gakuen
      'ff-brave-exvius': 'FINAL-FANTASY-BRAVE-EXVIUS',
      'new-world': 'New-World',
      'god-games': 'GODGAMES',
      'ff-grandmasters': 'FINAL-FANTASY-GRANDMASTERS',
      'tsurivaca': 'Minnano-Tsuri-Vacances',
      'raven': 'RAVEN',
      'line-arkanoid-vs-invader': 'LINE-Arkanoid-vs-Invader',
      'lost-regalia': 'Lost-Regalia',

      'dragonshout': 'Dragon-Shout',
      'bokudora': 'Boku-to-Dragon',
      'uncharted-collection': 'UNCHARTED-Collection',
      'hoshidora': 'Hoshi-no-DRAGON-QUEST',// Dragon Quest on the Stars
      '12sangokushi': '12Sangokushi',
      'lord-of-walkure': 'Lord-of-Walkure',
      'twd-road-to-survival': 'The-Walking-Dead-Road-to-Survival',
      'fanlab': 'Fantasy-Laboratory',
      'line-bubble2': 'LINE-Bubble-2',
      'otogi-war': 'OTOGI-WAR',

      'sankengou': 'Sankengou-Tenka-Seiha',
      'toy-blast': 'Toy-Blast',
      'deckheroes': 'Deck-Heroes',
      'jannavi': 'Jannavi-Mahjong-Online',
      'nouen-konkatsu': 'Nouen-Konkatsu',
      'koidere': 'Koisuru-Yoru-no-Cinderella',
      'monmusu-harem': 'Monmusu-Harem',
      'werewolf-nightmare-in-prison': 'Werewolf-Nightmare-in-Prison',
      'kimi-dra': 'Kimi-no-Himitsu-ni-Drama-na-Kiss-wo',
      'eleven-bakemons': 'Sin-Kaibutsu-Chronicle-Eleven-Bakemons',

      'idolish7': 'IDOLiSH7',
      'taikyoku-panda': 'Taikyoku-Panda',
      'cross-saga': 'Sangoku-Cross-SAGA',
      'elementalstory': 'Elemental-Story',
      'fantasydrive': 'Fantasy-Drive',
      'yu1000': 'Yusha-to-1000-no-Maou',
      'bravesword-blazesoul': 'Brave-Sword-Blaze-Soul',
      'recolove': 'Reco-Love-Blue-Ocean',
      'youkai-watch-busters-rwm': 'Yo-kai-Watch-Busters-RWM',
      'zelda-majoras-mask': 'The-Legend-of-Zelda-Majoras-Mask',

      'sangoku-tenbu': 'Sangoku-Tenbu',
      'aurcus': 'Aurcus-Online',
      'mafiamore': 'Mafiamore',
      'skygalleon': 'Soukyu-no-Skygalleon',
      'elemental-knights': 'Elemental-Knights-Online',
      'sephirot': 'Sephirot',
      'sangokushi-rumble': 'SANGOKUSHI-RANBU',
      'game-of-war': 'Game-of-War',
      'mercstoria': 'Merc-Storia',
      'avabel': 'Avabel-Online',

      'izanagi-online': 'IZANAGI-ONLINE',
      'stellacept': 'Stellacept-Online',
      'lord-of-knights': 'Lord-of-Knights',
      'arcana-magia': 'ARCANA-MAGIA',
      'ao-no-sangokushi': 'Ao-no-Sangokushi',
      'ikemen-o-oku': 'Sinsho-Ikemen-O-oku',
      'ikemen-royalpalace': 'Ikemen-Okyu',
      'pokecolo': 'Pokecolo',
      'jolly-roger': 'JOLLY-ROGER-Nazo-no-Bunmei-to-Kaizoku-Tou',
      'monster-master': 'MONSTER-MASTER',

      'legend-of-kingdom': 'Legend-of-Kingdom',
      'chainheroes': 'Chain-Heroes',
      'muscle-shot': 'Kinnikuman-Muscle-Shot',
      'sen-tama': 'SENTAMA',
      'cryptract': 'Genjuu-Keiyaku-Cryptract',
      'derby-owners-club': 'Derby-Owners-Club',
      'puyopuyoquest': 'Puyo-Puyo-Quest',
      'pso2es': 'PHANTASY-STAR-ONLINE2-es',
      'wotblitz': 'World-of-Tanks-Blitz',
      'world-soccer-collection': 'World-Soccer-Collection-S',

      'divinacute': 'Divina-Cute',
      '18': '18-Kimi-to-Tsunagaru-Puzzle',
      'the-tower-of-princess': 'THE-TOWER-OF-PRINCESS',
      'unison-league': 'Unison-League',
      'dqmsl': 'DRAGON-QUEST-MONSTERS-SUPER-LIGHT',
      'smashbros': 'Super-Smash-Bros-for-Nintendo-3DS-and-Wii-U',
      'shadowverse': 'Shadowverse',
      'rainbow-six-siege': 'Rainbow-Six-Siege',
      'rpg-maker-mv': 'RPG-Maker-MV',
      'sangokushi-maker': 'Sangokushi-Maker',// Romance of the Three Kingdoms Maker

      'fat-princess-adventures': 'Fat-Princess-Adventures',
      'fallout4': 'Fallout4',
      'fast-racing-neo': 'FAST-Racing-NEO',
      'zelda-ocarina-of-time': 'The-Legend-of-Zelda-Ocarina-of-Time',
      'ff6': 'FINAL-FANTASY-VI',
      'da-kamioroshi': 'Dasshutsu-Adventure-Kamioroshi-Uranai-Ban',
      'nejimaki-night2': 'Nejimaki-Knight-2',
      'drop-zone-under-fire': 'Drop-Zone-Under-Fire',
      'sokulibe': 'Soku-no-Liberasion',
      'othellonia': 'Othellonia',

      'arcanaslayer': 'Arcana-Slayer',
      'lastoftitan': 'LAST-OF-TITAN',
      'division': 'The-Division',
      'schoolstardream': 'School-Star-Dream',
      'tap-quest': 'Tap-Quest',
      'darksouls3': 'DARK-SOULS-III',
      'life-is-strange': 'Life-is-Strange',
      'dq-builders': 'DRAGON-QUEST-BUILDERS',
      'neet-yusha': 'Neet-Yusha',
      'neet-yusha2': 'Neet-Yusha-2',

      'neet-yusha3': 'Neet-Yusha-3',
      'rpg-k-d': 'RPG-karano-Dasshutsu',
      'pvz-gw2': 'Plants-vs-Zombies-Garden-Warfare-2',
      'candy-crush-jelly-saga': 'Candy-Crush-Jelly-Saga',
      'hero-kichi': 'Hasshin-Hero-Kichi',
      'rush-n-krush': 'Rush-N-Krush',
      'loveescape': 'Aisareruyori-Nogaretai',
      'seiran-koukou-himobu': 'Seiran-Koukou-Himobu',
      'nazotomo': 'Nazotomo',
      'ninshin-ikkagetsu': 'Ninshin-Ikkagetsu',

      'tennis-club-monogatari': 'Tennis-Club-Monogatari',
      'yowasete-caba': 'Yowasete-Kyaba-Jo',
      'dragonsinker': 'Dragon-Sinker',
      'i-am-god': 'I-AM-GOD',
      'patanko': 'PATANKO',
      'cosmicball-gt': 'CosmicBall-GT',
      'yuruneko-hakenshain': 'Yuruneko-hakenshain',
      'slashy-hero': 'Slashy-Hero',
      '3monogatari': 'Sangokushi-Monogatari',
      'driftgirls': 'Drift-Girls',

      'kanahei-kabu': 'Kanahei-no-Okina-Kabu',
      'gijinkanojo': 'Gijin-Kanojo',
      'gijinkanojo2': 'Gijin-Kanojo-2',
      'brave-fantasia': 'Brave-Fantasia',
      'dash-sushininja': 'Dash-Sushi-Ninja',
      'kodawari-ramen-kan': 'Kodawari-Ramen-Kan',
      'rain-dassyutsu-game': 'Rain-Dasshutsu-Game',
      'smurfs-epic-run': 'Smurfs-Epic-Run',
      'daikooon': 'Daikon-Ou-no-Yabou',
      'ragingloop': 'Raging-Loop',

      'blackknight-strikers': 'Black-Knight-Strikers',
      'grimmsnotes': 'Grimms-Notes',
      'girlandcircus': 'Warawanai-Shojo-to-Igyo-no-Circus',
      'gate-bs': 'GATE-Brave-Scramble',
      'zikkentou': 'Jikken-Tou',
      'cubecat-nya-nya-strike': 'CubeCat-Nyan-Nyan-Strike',
      'sorafc': 'Eiyu-Densetsu-Sora-no-Kiseki-FC',
      'nyankodama': 'Sengoku-Nyanko-Dama',
      'butsukarunner': 'ButsukaRunner-SNOW-MIKU-2016-Edition',
      'number-four-square': 'Dasshutsu-Game-No-Four-Square',

      'cho-ziku-eiyuden': 'Cho-Jiku-Eiyu-Den',
      'sfv': 'Street-Fighter-V',
      'alice-order': 'ALICE-ORDER',
      're1994': 'Re-1994',
      'egykoi': 'Egypt-Shin-to-Koishiyo',
      'vsbomber': 'Taisen-Bomberman',
      'uwaki-sinai': 'Boku-no-Kanojo-ha-Uwakinankashinai',
      'power-hover': 'Power-Hover',
      '12odins': '12-Odins',
      'geleemix': 'Geleemix-Puzzle-Party',

      'logicra': 'Logic-Crash',
      'fantasy-theater': 'Sanrio-Characters-Fantasy-Theater',
      'yogensha': 'Yogen-sha-Ikusei-Gakuen-Fortune-Tellers-Academy',
      'overwatch': 'Overwatch',
      'uncharted4': 'UNCHARTED4',
      'dqh2': 'DRAGON-QUEST-HEROES-II',
      'transformers-earthwars': 'TRANSFORMERS-Earth-Wars',
      'stardew-valley': 'Stardew-Valley',
      'the-tomorrow-children': 'The-Tomorrow-Children',
      'pokemon-go': 'Pokemon-GO',

      'super-mario-bros': 'Super-Mario-Bros',
      'mario-sonic-rio': 'Mario-and-Sonic-at-the-Rio-2016-Olympic-Games',
      'youkai-watch3': 'Yokai-Watch3',
      'idolmaster-platinum-stars': 'THE-iDOLMASTER-Platinum-Stars',
      'srwog-md': 'SUPER-ROBOT-WARS-OG-THE-MOON-DWELLERS',
      'sumikko3': 'Sumikko-Gurashi-Mura-wo-Tsukurundesu',
      'watch-dogs2': 'Watch-Dogs2',
      'pes2017': 'Winning-Eleven-2017',
      'garupan_app': 'Girls-und-Panzer-Senshado-Daisakusen',
      'abzu': 'ABZU',

      'etrian-odyssey5': 'Sekaiju-no-Meikyu-V',
      'battlefield1': 'Battlefield1',
      'kirby-planet-robobot': 'Kirby-Planet-Robobot',
      'dragonball-xenoverse2': 'DRAGON-BALL-XENOVERSE-2',
      'puzzle-and-dragons-x': 'Puzzle-and-Dragons-X',
      'atelier-sophie': 'Atelier-Sophie',
      'fifa17': 'FIFA-17',
      'gravitydaze2': 'GRAVITY-DAZE-2',
      'sanadamaru': 'Sengoku-Musou-Sanada-Maru',
      'ryu-ga-gotoku6': 'Ryu-ga-Gotoku-6',

      'macrossds': 'Macross-Delta-Scramble',
      'rocket-league': 'Rocket-League',
      'dead-star': 'Dead-Star',
      'alterna-girls': 'Alternative-Girls',
      'persona5': 'Persona5',
      'bks-dash': 'Black-Knight-Strikers-Dash',
      'tales-of-berseria': 'Tales-of-Berseria',
      '7daystodie': '7-Days-to-Die',
      'titanfall2': 'Titanfall-2',
      'big-city-stories': 'Big-City-Stories',

      'cod-bo': 'Call-of-Duty-Black-Ops',
      'mikuxhd': 'Hatsune-Miku-Project-DIVA-X',
      'valkyria': 'Valkyria-Revolution',
      'utaware': 'Utawarerumono-Futari-no-Hakuoro',
      ...
      'chaos-chronicle': 'Chaos-Chronicle',
      'trico': 'Hitokui-no-Owashi-Toriko',// The Last Guardian

      'maplestory': 'MapleStory',
      'umbrella-corps': 'BIOHAZARD-UMBRELLA-CORPS',
      'touhou145': 'Touhou-Shinpiroku',
      'gran-turismo-sport': 'Gran-Turismo-Sport',
      'yorukuni': 'Yoru-no-Nai-Kuni',
      'yorukuni2': 'Yoru-no-Nai-Kuni-2',
      'sd-gundam-ggg': 'SD-GUNDAM-G-GENERATION-GENESIS',
      'f1-2016': 'F1-2016',
      'genshin-cross-to-fate': 'Gensou-Shiniki-Cross-to-Fate',
      'lodoss': 'Record-of-Lodoss-War-Online',

      'meet-me': 'Meet-Me',
      'pokemon-sun-moon': 'Pokemon-Sun-and-Moon',
      'nobunaga-online': 'Nobunaga-no-Yabou-Online',
      'fushigentod-r': 'Fushigi-no-Gensokyo-TOD-RELOADED',
      'tokyo-xanadu-explus': 'TOKYO-XANADU-eX-Plus',
      ...
      'resident-evil7': 'BIOHAZARD-7',
      'dragonball-fusions': 'DRAGON-BALL-Fusions',
      'cod-iw': 'Call-of-Duty-Infinite-Warfare',
      'mabinogi': 'mabinogi',
      'god-wars': 'GOD-WARS',
      'witcher3': 'The-Witcher-3',
      'wizardry-online': 'Wizardry-Online',
      'saga-sg': 'SaGa-SCARLET-GRACE',

      'nier-automata': 'NieR-Automata',
      'rez-infinite': 'Rez-Infinite',
      'blade-and-soul': 'Blade-and-Soul',
      'evolve': 'Evolve',
      'dragon-craze': 'Dragon-Craze',
      'diablo2': 'Diablo-II',
      'giga-wrecker': 'GIGA-WRECKER',
      'sao-lostsong': 'SWORD-ART-ONLINE-LOST-SONG',
      'sao-hr': 'SWORD-ART-ONLINE-Hollow-Realization',
      'world-of-warcraft': 'World-of-Warcraft',

      'cosmic-break': 'Cosmic-Break',
      'mh-stories': 'MONSTER-HUNTER-STORIES',
      'nfs2015': 'Need-for-Speed-2015',
      'lunatia': 'LUNATIA',
      'arcanehearts': 'Arcane-Hearts',
      'black-desert': 'Black-Desert',
      'from-the-depths': 'From-the-Depths',
      'demon-gaze': 'Demon-Gaze',
      'demon-gaze2': 'Demon-Gaze-II',
      'rimworld': 'RimWorld',

      'gran-turismo6': 'Gran-Turismo-6',
      'granado-espada': 'Granado-Espada',
      'mh-x': 'MONSTER-HUNTER-X',
      'pso2': 'Phantasy-Star-Online-2',
      'dragons-dogma': 'Dragons-Dogma',
      'shironeko-tennis': 'Shironeko-Tennis',
      'smite': 'SMITE',
      'new-danganronpa-v3': 'New-Danganronpa-V3',
      'school-girl-zombie-hunter': 'School-Girl-Zombie-Hunter',
      'summoners-war': 'Summoners-War',

      'dbz-dokkan': 'DRAGON-BALL-Z-DOKKAN-BATTLE',
      'mahouotome': 'Gothic-ha-Mahou-Otome',
      'khhd-fcp': 'KINGDOM-HEARTS-HD-2-8',
      'riderrevo': 'All-Kamen-Rider-Rider-Revolution',
      'soul-chronicle': 'Soul-Chronicle',
      'civ4': 'Civilization-IV',
      'civ5': 'Civilization-V',
      'civ6': 'Civilization-VI',
      'anno2205': 'Anno-2205',
      'edf4-1': 'EARTH-DEFENSE-FORCE-4-1',

      'death-stranding': 'DEATH-STRANDING',
      'tricky-towers': 'Tricky-Towers',
      'resident-evil4': 'BIOHAZARD-4',
      'mario-kart-wii': 'Mario-Kart-Wii',
      'the-tower-of-aion': 'The-Tower-of-AION',
      'edf5': 'EARTH-DEFENSE-FORCE-5',
      'skyrim': 'The-Elder-Scrolls-V-Skyrim',
      'nba2k17': 'NBA-2K17',
      'dqmp': 'DRAGON-QUEST-MONSTER-PARADE',
      'animal-crossing-new-leaf': 'The-Animal-Crossing-New-Leaf',

      'kagura-pbs': 'SENRAN-KAGURA-PEACH-BEACH-SPLASH',
      'sangokushi-royale': 'Sangokushi-Royale',
      'happy-wars': 'Happy-Wars',
      'bloodstained-ritual-of-the-night': 'Bloodstained-Ritual-of-the-Night',
      'wiz-gaiden-five-ordeals': 'Wizardry-Gaiden-Five-Ordeals',
      'craft-the-world': 'Craft-The-World',
      'eve-online': 'EVE-Online',
      're-zero-death-or-kiss': 'Re-Zero-DEATH-OR-KISS',
      'osomatsusan-matsumatsuri': 'Osomatsu-san-Matsumatsuri',
      'paper-mario-color-splash': 'Paper-Mario-Color-Splash',

      'grim-dawn': 'Grim-Dawn',
      'marvelheroes2016': 'Marvel-Heroes-2016',
      'van-helsing': 'The-Incredible-Adventures-of-Van-Helsing',
      'wargame-red-dragon': 'Wargame-Red-Dragon',
      'barony': 'Barony',
      'metalsenki': 'Metal-Senki',
      'world-of-tanks': 'World-of-Tanks',
      'crusader-kings2': 'Crusader-Kings-II',
      'driver-san-francisco': 'DRIVER-SAN-FRANCISCO',
      'fantasy-earth-zero': 'Fantasy-Earth-Zero',

      'chocotto-land': 'Chocotto-Land',
      'kuniokun-complete': 'Kunio-kun-Nekketsu-Complete',
      'gears-of-war4': 'Gears-of-War-4',
      'untildawn-rob': 'Until-Dawn-Rush-of-Blood',
      'tsumiki-bloq': 'Tsumiki-BLOQ',
      'driveclub-vr': 'DRIVECLUB-VR',
      'thumper': 'Thumper',
      'psvr-worlds': 'PlayStation-VR-Worlds',
      ...
      'stellaris': 'Stellaris',
      'the-sims4': 'The-Sims-4',
      'mario-party-star-rush': 'Mario-Party-Star-Rush',
      'age-of-empires2': 'Age-of-Empires-II',
      'age-of-empires2-hd': 'Age-of-Empires-II-HD',
      'oregairu-game': 'Oregairu-Game',
      'oregairu-game2': 'Oregairu-Game-2',
      'berserk-musou': 'Berserk-Musou',

      'sangokublaze': 'Sangoku-Blaze',
      'digimon-linkz': 'DIGIMON-LINKZ',
      'kof98umol': 'THE-KING-OF-FIGHTERS-98-ULTIMATE-MATCH-Online',
      'elite-dangerous': 'Elite-Dangerous',
      'diablo3': 'Diablo-III',
      'a-train-pc': 'Minnano-A-Ressha-de-Ikou-PC',
      'neo-atlas1469': 'Neo-ATLAS-1469',
      'pawapuro-success-sp': 'Jikkyo-Powerful-Pro-Yakyu-Success-SP',
      'pawapuro2016': 'Jikkyo-Powerful-Pro-Yakyu-2016',
      'atelier-firis': 'Atelier-Firis',

      'momotetsu2017': 'Momotarou-Dentetsu-2017',
      'hearts-of-iron4': 'Hearts-of-Iron-IV',
      'echo-of-soul': 'ECHO-OF-SOUL',
      'layers-of-fear': 'Layers-of-Fear',
      'witch100knight': 'Majo-to-Hyakkihei',
      'witch100knight2': 'Majo-to-Hyakkihei-2',
      'dungeon-travelers': 'Dungeon-Travelers',
      'dungeon-travelers2': 'Dungeon-Travelers-2',
      '4goddesses-online': '4-Goddesses-Online',
      'fate-extella': 'Fate-EXTELLA',

      'batman-arkham-asylum': 'Batman-Arkham-Asylum',
      'batman-arkham-city': 'Batman-Arkham-City',
      'toho-kobuto-v': 'Toho-Kobuto-V',
      'darksouls2': 'DARK-SOULS-II',
      'gigantic': 'Gigantic',
      'the-legend-of-heroes-trails-of-cold-steel': 'Eiyu-Densetsu-Sen-no-Kiseki',
      'the-legend-of-heroes-trails-of-cold-steel2': 'Eiyu-Densetsu-Sen-no-Kiseki-2',
      'halo-wars': 'Halo-Wars',
      'halo-wars2': 'Halo-Wars-2',
      'srw-v': 'SUPER-ROBOT-WARS-V',

      'forza-horizon3': 'Forza-Motorsport-3',
      'lineage': 'Lineage',
      'heros-song': 'Heros-Song',
      'grand-kingdom': 'Grand-Kingdom',
      'pripara-megami': 'PriPara-Mezameyo-Megami-no-Dress-Design',
      'pes-club-manager': 'Winning-Eleven-Club-Manager',
      'seven-knights': 'Seven-Knights',
      'senkan-shojo-r': 'Senkan-Shojo-R',
      'tyranny': 'Tyranny',
      'factorio': 'Factorio',

      'tales-of-graces-f': 'Tales-of-Graces-f',
      'path-of-exile': 'Path-of-Exile',
      'farming-simulator17': 'Farming-Simulator-17',
      'steep': 'Steep',
      'starcrawlers': 'StarCrawlers',
      'besiege': 'Besiege',
      'wii-fit-u': 'Wii-Fit-U',
      'everquest2': 'EverQuest-II',
      ...
      'archeage': 'ArcheAge',
      'seventh-dark': 'SEVENTH-DARK',
      'blazblue-revolution-reburning': 'BLAZBLUE-REVOLUTION-REBURNING',
      'sengoku-asuka-zero': 'Sengoku-Asuka-ZERO',
      'resident-evil-revelations': 'BIOHAZARD-Revelations',
      'children-of-a-dead-earth': 'Children-of-a-Dead-Earth',
      'ea-sports-ufc': 'EA-SPORTS-UFC',
      'ea-sports-ufc2': 'EA-SPORTS-UFC-2',
      ...
      'pokemon-xy': 'Pokemon-X-and-Y',
      'one-piece-dance-battle': 'One-Piece-Dance-Battle',
      'birthdays-the-beginning': 'Birthdays-the-Beginning',
      'dragon-age-inquisition': 'Dragon-Age-Inquisition',

      'mario-kart-ds': 'Mario-Kart-DS',
      'shingeki': 'Shingeki-no-Kyojin',
      'supermario-3d-land': 'Super-Mario-3D-Land',
      'dq11': 'DRAGON-QUEST-XI',
      'donkey-kong': 'Donkey-Kong',
      'ark-se': 'ARK-Survival-Evolved',
      'donkey-kong-jr': 'DONKEY-KONG-JR',
      'popeye': 'Popeye',
      'gomoku-narabe-renju': 'Gomoku-Narabe-Renju',
      'mario-bros': 'Mario-Bros',

      'popeye-no-eigo-asobi': 'Popeye-no-Eigo-Asobi',
      'baseball': 'Baseball',
      ...
      'nfs-edge': 'Need-for-Speed-Edge',
      'unturned': 'Unturned',
      'player-unknowns-battlegrounds': 'PLAYERUNKNOWNS-BATTLEGROUNDS',
      'family-basic': 'Family-BASIC',
      'donkey-kong3': 'Donkey-Kong-3',
      'nuts-and-milk': 'Nuts-and-Milk',
      ...
      'bungeling-bay': 'Raid-on-Bungeling-Bay',
      'mh-world': 'MONSTER-HUNTER-WORLD',
      'dq-rivals': 'DRAGON-QUEST-RIVALS',
      'cod-wwii': 'Call-of-Duty-WWII',
      'shiren': 'Furai-no-Shiren',
      ...
      'dq-builders2': 'DRAGON-QUEST-BUILDERS-2',
      'hollow-knight': 'Hollow-Knight',
      'super-mario-maker-2': 'Super-Mario-Maker-2',
      'obakeidoro': 'OBAKEIDORO',
      'pvz-bfn': 'Plants-vs-Zombies-Battle-for-Neighborville',
      'borderlands3': 'Borderlands-3',

      'orekou': 'Oreno-Koshien',
      'piyo-shougi': 'Piyo-Shogi',
      'mario-kart8': 'Mario-Kart-8',
      'among-us': 'Among-US',

    }

    for (const [key, value] of Object.entries(redirectGamesUrlIDObj)) {
    ...
    for (const [index, valueObj] of gameDataDataArr.entries()) {
      ...
      let urlID = lodashGet(valueObj, ['id'], '');

      // if (game_no === '661') {
      //   sortKeyword = 'ドライバーサンフランシスコ';
      // }

      if (redirectGamesUrlIDObj[urlID]) {
        urlID = redirectGamesUrlIDObj[urlID];
      }
