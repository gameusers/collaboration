...
const findForumByforumID = async ({
  ...
  try {
    ...
    const forumThreads_id = lodashGet(forumCommentsAndRepliesObj, ['forumThreads_id'], forumID);
...
const findFeed = async ({
  ...
  try {
    ...
    for (let valueObj of docArr.values()) {
      ...
      const gamesImagesAndVideosObj = formatImagesAndVideosObj({ localeObj, obj: lodashGet(valueObj, ['gamesObj', 'imagesAndVideosObj'], {}) });
      ...
      clonedObj.commentsAndReplies = valueObj.comments + valueObj.replies;
      ...
      feedForumThreadsObj.dataObj[valueObj._id] = clonedObj;
      ...
      const pagesArr = lodashGet(feedForumThreadsObj, [`page${page}Obj`, 'arr'], []);
      pagesArr.push(valueObj._id);
      
      feedForumThreadsObj[`page${page}Obj`] = {
    ...
    console.log(`
      ----- feedForumThreadsObj -----\n
      ${util.inspect(JSON.parse(JSON.stringify(feedForumThreadsObj)), { colors: true, depth: null })}\n
      --------------------\n
    `);
