  ...
  return (
    <React.Fragment>
      ...
      <TextField
        ...
        helperText={intl.formatMessage({ id: validationModelObj.messageID }, { numberOfCharacters: validationModelObj.numberOfCharacters })}
        margin="normal"
        inputProps={{
          maxLength: 50,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'cpuCooler')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'motherboard')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'storage')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'graphicsCard')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'opticalDrive')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'powerSupply')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'monitor')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
      ...
      <TextField
        ...
        onChange={(eventObj) => handleOnChange(eventObj.target.value, 'keyboard')}
        margin="normal"
        inputProps={{
          maxLength: 100,
        }}
