...
const ContainerLayout = (props) => {
  ...
  const componentContent =
    <React.Fragment>
      ...
      <h1>データベース</h1>
      <p>以下のボタンを押すと、MongoDB の gameusers データベース内に、初期データを挿入します。データを初期状態に戻したいときにも利用できます。</p>
      ...
      <p>トップページ<br />
      <a href={urlBase} target="_blank">{urlBase}</a></p>

      <p>ユーザーコミュニティ一覧<br />
      <a href={`${urlBase}uc/list`} target="_blank">{`${urlBase}uc/list`}</a></p>

      <p>ゲームコミュニティ一覧<br />
      <a href={`${urlBase}gc/list`} target="_blank">{`${urlBase}gc/list`}</a></p>

      <p>ログイン<br />
      <a href={`${urlBase}login`} target="_blank">{`${urlBase}login`}</a></p>

      <p>ログアウト<br />
      <a href={`${urlBase}logout`} target="_blank">{`${urlBase}logout`}</a></p>

      <p>ゲームコミュニティ（現在はこのページを作成中）<br />
      <a href={`${urlBase}gc/Dead-by-Daylight`} target="_blank">{`${urlBase}gc/Dead-by-Daylight`}</a></p>

      <p>ユーザーコミュニティ<br />
      <a href={`${urlBase}uc/community1`} target="_blank">{`${urlBase}uc/community1`}</a></p>

      <p>ユーザー<br />
      <a href={`${urlBase}ur/user1`} target="_blank">{`${urlBase}ur/user1`}</a></p>
