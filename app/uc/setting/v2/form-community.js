    ...
    >
      ...
      <form>
        ...
        <div css={cssBox}>
          ...
          <p>
            コミュニティ内部のコンテンツを閲覧できる相手を制限し、コミュニティの更新情報（フォーラムへの書き込みなど）を Game Users のトップページなどに表示するかどうかの設定になります。
          </p>
          ...
          <p
            ...
            `}
          >
            オープン：コミュニティを誰でも閲覧できます。更新情報が Game Users のトップページなどにフィードとして掲載されます。
          </p>
